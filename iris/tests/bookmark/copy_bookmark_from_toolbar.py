...
class Test(BaseTest):
    ...
    def run(self):
        ...
        assert_true(self, iris_tab_available, '\'Iris\' tab is available after launching Firefox')
        ...
        bookmark_available_in_toolbar = exists(getting_started_bookmark_pattern, DEFAULT_SHORT_FIREFOX_TIMEOUT)
        ...
        copy_option_available = exists(copy_option_pattern, DEFAULT_SHORT_FIREFOX_TIMEOUT)
        ...
        other_bookmarks_folder_available = exists(other_bookmarks_folder_pattern, DEFAULT_SHORT_FIREFOX_TIMEOUT)
        ...
        paste_option_available = exists(paste_option_pattern, DEFAULT_SHORT_FIREFOX_TIMEOUT)
